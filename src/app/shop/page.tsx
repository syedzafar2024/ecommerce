  ...
  return (
    <div className="items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] bg-mygray">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4  gap-6 mt-6 sm:mt-10 mx-2 sm:mx-4">
                    <div className="space-y-4 border border-green-500 rounded-2xl"><Image src={pic01} alt="" />
                    <p className="text-base leading-[24px]">Trenton modular sofa_3</p>
                    <p className="text-[24px] leading-[36px]">Rs. 25,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500 rounded-2xl"><Image src={pic02} alt="" />
                    <p>Granite dining table with dining chair</p>
                    <p className="text-[24px] leading-[36px]">Rs. 25,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500 rounded-2xl"><Image src={pic03} alt="" />
                    <p>Outdoor bar table and stool</p>
                    <p className="text-[24px] leading-[36px]">Rs. 25,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500 rounded-2xl"><Image src={pic04} alt="" />
                    <p>Plain console with teak mirror</p>
                    <p className="text-[24px] leading-[36px]">Rs. 25,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic05} alt="" />
                    <p>Grain coffee table</p>
                    <p className="text-[24px] leading-[36px]">Rs. 15,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic06} alt="" />
                    <p>Grain coffee table</p>
                    <p className="text-[24px] leading-[36px]">Rs. 225,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic07} alt=""/>
                    <p>Round coffee table_color 2</p>
                    <p className="text-[24px] leading-[36px]">Rs. 251,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic08} alt=""/>
                    <p>Reclaimed teak coffee table</p>
                    <p className="text-[24px] leading-[36px]">Rs. 25,200.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic09} alt="" />
                    <p>Plain console_</p>
                    <p className="text-[24px] leading-[36px]">Rs. 258,200.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic10} alt="" />
                    <p>Reclaimed teak Sideboard</p>
                    <p className="text-[24px] leading-[36px]">Rs. 20,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic11} alt=""  />
                    <p>SJP_0825 </p>
                    <p className="text-[24px] leading-[36px]">Rs. 200,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic12} alt=""/>
                    <p>Bella chair and table</p>
                    <p className="text-[24px] leading-[36px]">Rs. 100,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic13} alt="" />
                    <p>Granite square side table</p>
                    <p className="text-[24px] leading-[36px]">Rs. 258,800.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic14} alt=""  />
                    <p>Asgaard sofa</p>
                    <p className="text-[24px] leading-[36px]">Rs. 250,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic15} alt="" />
                    <p>Maya sofa three seater</p>
                    <p className="text-[24px] leading-[36px]">Rs. 115,000.00</p>
                    </div>
                    <div className="space-y-4 border border-green-500"><Image src={pic16} alt="" />
